...
public static class RuleMetadataCatalog
{
    ...
    [
        ...
        Define(RuleField.FromCountryId, RuleTriggerType.DecodeMessage, RuleValueType.Number, RuleOperator.Equals, RuleOperator.NotEquals, RuleOperator.In, RuleOperator.NotIn, RuleOperator.InNamedSet, RuleOperator.NotInNamedSet),
        Define(RuleField.ToCountryId, RuleTriggerType.DecodeMessage, RuleValueType.Number, RuleOperator.Equals, RuleOperator.NotEquals, RuleOperator.In, RuleOperator.NotIn, RuleOperator.InNamedSet, RuleOperator.NotInNamedSet),
